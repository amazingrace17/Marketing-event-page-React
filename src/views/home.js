  ...
  return (
    <div className={styles['container']}>
      ...
      <main className={styles['Main']}>
        ...
        <div
          className={` ${styles['NumbersBanner']} ${projectStyles['section-container']} `}
        >
          <div
        ...
        <div
          className={` ${styles['PreviousEvents']} ${projectStyles['section-container']} `}
        >
          <div
          ...
          <div data-type="slider" className={styles['Slider']}>
            <Slide rootClassName="rootClassName4"></Slide>
            <Slide heading="Slide #2" rootClassName="rootClassName1"></Slide>
            <Slide heading="Slide #3" rootClassName="rootClassName"></Slide>
            <Slide heading="Slide #4" rootClassName="rootClassName3"></Slide>
            <Slide heading="Slide #5" rootClassName="rootClassName2"></Slide>
          </div>
