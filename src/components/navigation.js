    ...
    >
      <div className={styles['max-width']}>
        ...
        <div className={styles['Nav']}>
          ...
          <Link
            to="/register"
            className={` ${styles['Register']} ${projectStyles['button-primary']} ${projectStyles['button']} ${projectStyles['button-md']} `}
          >
            {props.button}
          </Link>
        </div>
        ...
        <div data-type="MobileMenu" className={styles['MobileMenu']}>
          <div className={styles['Nav1']}>
            ...
            <button
              className={` ${styles['Register1']} ${projectStyles['button-primary']} ${projectStyles['button']} ${projectStyles['button-md']} `}
            >
              {props.button1}
            </button>
          </div>
