      ...
      >
        <div className={styles['banner']}>
          ...
          <div className={styles['btns-container']}>
            <button
              className={` ${styles['register-now']} ${projectStyles['button-primary']} ${projectStyles['button-lg']} ${projectStyles['button']} `}
            >
              register NOW
            </button>
            <button
              className={` ${styles['contact-us']} ${projectStyles['button']} ${projectStyles['button-outline']} ${projectStyles['button-lg-border']} `}
            >
              CONTACT US
            </button>
          </div>
        ...
        <div className={styles['bottom-container']}>
          <div className={styles['left-side']}>
            ...
            <div className={styles['SocialMedia']}>
              <span className={styles['text07']}>Follow market1</span>
          ...
          <div className={styles['Links']}>
            <div className={styles['container1']}>
              <span className={styles['text08']}>Product</span>
              <span className={projectStyles['footer-link']}>ABOUT</span>
              <span className={projectStyles['footer-link']}>Agenda</span>
              <span className={projectStyles['footer-link']}>Register</span>
              <span className={projectStyles['footer-link']}>Speakers</span>
              <span className={projectStyles['footer-link']}>Location</span>
              <span
            ...
            <div className={styles['container2']}>
              ...
              <span className={projectStyles['footer-link']}>contact us</span>
              <span className={projectStyles['footer-link']}>Sponsorship</span>
              <span className={projectStyles['footer-link']}>
                become a speaker
              </span>
              <span className={projectStyles['footer-link']}>partnerships</span>
              <span
                className={` ${styles['text22']} ${projectStyles['footer-link']} `}
              >
                sales
              </span>
            </div>
        ...
        <div className={styles['Copyright']}>
          <span className={styles['text23']}>
            ...
            >
              <span className={styles['text27']}>@TeleportHQ.</span>
            </a>
            <span>
              <span>
                {' '}
            ...
            <a
              ...
              rel="noreferrer noopener"
            >
              <span className={styles['text31']}>Vercel</span>
            </a>
            <span>
              <span>
                . Image source:
            ...
            <a
              ...
              rel="noreferrer noopener"
            >
              <span className={styles['text35']}>Unsplash</span>
            </a>
            <span>.</span>
          </span>
        </div>
